...
INSERT INTO roles_default_settings 
(id,role_id,role_name,view_report,add_user,delete_user,modified_user,client_id,client_name) VALUES
(5,1,'Admin',1,1,1,1,1,'SGS');
...
VALUES (1,1,'Allocater',1,'New',111,'Ready For Allocation','readyForAllocationBg');
INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
VALUES (2,1,'Allocater',1,'New',222,'Rejected','rejectedBg');
INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
VALUES (3,1,'Allocater',2,'Allocated',333,'Allocat to TL','allocateToTLBg');
INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
VALUES (4,1,'Allocater',2,'Allocated',444,'Allocat to Coder','allocateToCoderBg');
INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
VALUES (5,1,'Allocater',4,'Completed',666,'Coding Completed','codingCompletedBg');

-- TL_Allocater

INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
VALUES (7,2,'TL_Allocater',1,'New',333,'Allocat to TL','allocateToTLBg');
INSERT INTO role_bucket_status_map (id,role_id,role_name,bucket_id,bucket_value,status_id,status_value,status_css_class) 
